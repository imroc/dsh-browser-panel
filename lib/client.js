  ...
  factory: (require) => {
    ...
    const DICT = {
      zh: {
        ...
        instructions: '在下方直接操作容器内的浏览器：输入账号密码、扫码或填验证码都可以，AI 能看到同一个页面。',
      },
      en: {
        title: 'Browser',
        ...
        instructions: 'Operate the container browser right here: type credentials, scan a QR code, answer a prompt. The AI sees the same page.',
      },
    }
    ...
    const CSS = `
      ...
      [data-dsh-browser-panel] .dbp-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:10px;color:var(--dsw-alias-label-secondary,#999);font-size:13px;text-align:center;padding:24px}
      ...
      return h(
        ...
        h(
          ...
          failure !== undefined
            ...
            : bitmapRef.current === undefined && connection === 'connected'
